...
% Checks if the piece above is an enemy piece and if so, increments the accumulator
flip_check_up(Board, Enemy, LineIndex, ColumnIndex, Accumulator):-
    LineIndex>0,
...
% Checks if the piece below is an enemy piece and if so, increments the accumulator
flip_check_down(Board, Enemy, LineIndex, ColumnIndex, Accumulator):-
...
% Returns the longest vertical segment that a piece at LineIndex-ColumnIndex is part of
flip_check_vertical(Board, Enemy, LineIndex, ColumnIndex, Longestinput, Longestoutput):-
...
% Checks if the piece to the left is an enemy piece and if so, increments the accumulator
flip_check_left(Board, Enemy, LineIndex, ColumnIndex, Accumulator):-
    ColumnIndex>0,
    get_piece(Board, LineIndex, ColumnIndex, Enemy),
...
% Checks if the piece to the right is an enemy piece and if so, increments the accumulator
flip_check_right(Board, Enemy, LineIndex, ColumnIndex, Accumulator):-
...
% Returns the longest horizontal segment that a piece at LineIndex-ColumnIndex is part of
flip_check_horizontal(Board, Enemy, LineIndex, ColumnIndex, Longestinput, Longestoutput):-
...
% Flips the pieces to the left of a piece at LineIndex-ColumnIndex
...
% Flips the pieces to the right of a piece at LineIndex-ColumnIndex
...
% Flips the pieces above a piece at LineIndex-ColumnIndex
...
% Flips the pieces below a piece at LineIndex-ColumnIndex
